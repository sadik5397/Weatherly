define(['dart_sdk', 'packages/weatherly/main'], function(dart_sdk, packages__weatherly__main) {
  'use strict';
  ...
  const main = packages__weatherly__main.main;
  ...
  dart.trackLibraries("packages/weatherly/main_web_entrypoint", {
    "package:weatherly/main_web_entrypoint.dart": main_web_entrypoint
  }, {
