define(['dart_sdk'], function(dart_sdk) {
  ...
  const Cubic_x1 = dart.privateName(cubic_ease, "Cubic.x1");
  const Cubic_y1 = dart.privateName(cubic_ease, "Cubic.y1");
  const Cubic_x2 = dart.privateName(cubic_ease, "Cubic.x2");
  const Cubic_y2 = dart.privateName(cubic_ease, "Cubic.y2");
