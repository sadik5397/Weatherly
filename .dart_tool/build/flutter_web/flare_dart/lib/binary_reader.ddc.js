define(['dart_sdk'], function(dart_sdk) {
  ...
  const BlockReader_blockType = dart.privateName(block_reader, "BlockReader.blockType");
  ...
  const blockType$ = BlockReader_blockType;
  ...
  const StreamReader_blockType = dart.privateName(stream_reader, "StreamReader.blockType");
  ...
  const blockType = StreamReader_blockType;
  ...
  let C0;
  const JSONReader_blockType = dart.privateName(json_reader, "JSONReader.blockType");
  ...
  const blockType$0 = JSONReader_blockType;
