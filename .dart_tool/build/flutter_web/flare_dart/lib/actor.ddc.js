define(['dart_sdk', 'packages/flare_dart/math/mat2d', 'packages/flare_dart/block_types', 'packages/flare_dart/math/aabb', 'packages/flare_dart/binary_reader', 'packages/flare_dart/animation/property_types', 'packages/flare_dart/animation/interpolation/hold', 'packages/flare_dart/animation/interpolation/linear', 'packages/flare_dart/animation/interpolation/cubic', 'packages/flare_dart/animation/interpolation/interpolator', 'packages/flare_dart/path_point'], function(dart_sdk, packages__flare_dart__math__mat2d, packages__flare_dart__block_types, packages__flare_dart__math__aabb, packages__flare_dart__binary_reader, packages__flare_dart__animation__property_types, packages__flare_dart__animation__interpolation__hold, packages__flare_dart__animation__interpolation__linear, packages__flare_dart__animation__interpolation__cubic, packages__flare_dart__animation__interpolation__interpolator, packages__flare_dart__path_point) {
  ...
  const ActorClip_clipIdx = dart.privateName(actor_node, "ActorClip.clipIdx");
  const ActorClip_intersect = dart.privateName(actor_node, "ActorClip.intersect");
  const ActorClip_node = dart.privateName(actor_node, "ActorClip.node");
  ...
  const clipIdx$ = ActorClip_clipIdx;
  const intersect = ActorClip_intersect;
  const node = ActorClip_node;
  ...
  const ActorComponent_parent = dart.privateName(actor_component, "ActorComponent.parent");
  const ActorComponent_artboard = dart.privateName(actor_component, "ActorComponent.artboard");
  const ActorComponent_idx = dart.privateName(actor_component, "ActorComponent.idx");
  const ActorComponent_graphOrder = dart.privateName(actor_component, "ActorComponent.graphOrder");
  const ActorComponent_dirtMask = dart.privateName(actor_component, "ActorComponent.dirtMask");
  const ActorComponent_dependents = dart.privateName(actor_component, "ActorComponent.dependents");
  ...
  const parent = ActorComponent_parent;
  const artboard$ = ActorComponent_artboard;
  const idx = ActorComponent_idx;
  const graphOrder = ActorComponent_graphOrder;
  const dirtMask = ActorComponent_dirtMask;
  const dependents = ActorComponent_dependents;
  ...
  const ActorBone_jelly = dart.privateName(actor_bone, "ActorBone.jelly");
  ...
  const DrawOrderIndex_componentIndex = dart.privateName(keyframe, "DrawOrderIndex.componentIndex");
  const DrawOrderIndex_order = dart.privateName(keyframe, "DrawOrderIndex.order");
  ...
  const componentIndex = DrawOrderIndex_componentIndex;
  const order = DrawOrderIndex_order;
  ...
  const ActorSkinnable_skin = dart.privateName(actor_skinnable, "ActorSkinnable.skin");
  ...
  const skin = ActorSkinnable_skin;
  ...
  const ActorPath_vertexDeform = dart.privateName(actor_path, "ActorPath.vertexDeform");
  ...
  const vertexDeform = ActorPath_vertexDeform;
  ...
  const SkinnedBone_boneIdx = dart.privateName(actor_skinnable, "SkinnedBone.boneIdx");
  const SkinnedBone_node = dart.privateName(actor_skinnable, "SkinnedBone.node");
  const SkinnedBone_bind = dart.privateName(actor_skinnable, "SkinnedBone.bind");
  const SkinnedBone_inverseBind = dart.privateName(actor_skinnable, "SkinnedBone.inverseBind");
  ...
  const boneIdx = SkinnedBone_boneIdx;
  const node$ = SkinnedBone_node;
  const bind = SkinnedBone_bind;
  const inverseBind = SkinnedBone_inverseBind;
  ...
  const ActorDrawable_drawIndex = dart.privateName(actor_drawable, "ActorDrawable.drawIndex");
  const ActorDrawable_isHidden = dart.privateName(actor_drawable, "ActorDrawable.isHidden");
  ...
  const drawIndex = ActorDrawable_drawIndex;
  const isHidden = ActorDrawable_isHidden;
  ...
  const ClipShape_shape = dart.privateName(actor_drawable, "ClipShape.shape");
  const ClipShape_intersect = dart.privateName(actor_drawable, "ClipShape.intersect");
  ...
  const shape$ = ClipShape_shape;
  const intersect$ = ClipShape_intersect;
  ...
  const RadialGradientColor_secondaryRadiusScale = dart.privateName(actor_color, "RadialGradientColor.secondaryRadiusScale");
  ...
  const secondaryRadiusScale = RadialGradientColor_secondaryRadiusScale;
  ...
  const ActorImage_drawOrder = dart.privateName(actor_image, "ActorImage.drawOrder");
  ...
  const drawOrder = ActorImage_drawOrder;
  ...
  const ActorPolygon_sides = dart.privateName(actor_polygon, "ActorPolygon.sides");
  ...
  const sides = ActorPolygon_sides;
  ...
  const InfluencedBone_boneIdx = dart.privateName(actor_ik_constraint, "InfluencedBone.boneIdx");
  const InfluencedBone_bone = dart.privateName(actor_ik_constraint, "InfluencedBone.bone");
  ...
  const boneIdx$ = InfluencedBone_boneIdx;
  const bone = InfluencedBone_bone;
  ...
  const BoneChain_index = dart.privateName(actor_ik_constraint, "BoneChain.index");
  const BoneChain_bone = dart.privateName(actor_ik_constraint, "BoneChain.bone");
  const BoneChain_angle = dart.privateName(actor_ik_constraint, "BoneChain.angle");
  const BoneChain_included = dart.privateName(actor_ik_constraint, "BoneChain.included");
  const BoneChain_transformComponents = dart.privateName(actor_ik_constraint, "BoneChain.transformComponents");
  const BoneChain_parentWorldInverse = dart.privateName(actor_ik_constraint, "BoneChain.parentWorldInverse");
  ...
  const index = BoneChain_index;
  const bone$ = BoneChain_bone;
  const angle = BoneChain_angle;
  const included = BoneChain_included;
  const transformComponents = BoneChain_transformComponents;
  const parentWorldInverse = BoneChain_parentWorldInverse;
  ...
  const Actor_maxTextureIndex = dart.privateName(actor, "Actor.maxTextureIndex");
  ...
  const maxTextureIndex = Actor_maxTextureIndex;
